...
tax.left_axis_label("$C1$", offset=0.16, color=axes_colors['l'])
tax.right_axis_label("$C2$", offset=0.16, color=axes_colors['r'])
tax.bottom_axis_label("$C3$", offset=-0.06, color=axes_colors['b'])
